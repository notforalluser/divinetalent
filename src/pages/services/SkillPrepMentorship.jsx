...
// export function SkillPrepMentorshipPage() {
...
//     {
//       icon: GraduationCap,
//       title: "Premium Prep Vault Access",
//       description: "Role-based learning paths: system design, DSA, case studies, SQL, ML – whatever your job needs, we've curated content that saves you from rabbit holes and Reddit confusion."
//     },
//     {
//       icon: Users,
//       title: "1:1 Mentor Matching",
//       description: "We pair you with mentors from FAANG, high-growth startups, or domain-specific roles. Not random. Matched by skill, role, and seniority."
//     },
//     {
//       icon: Video,
//       title: "Live Mock Rounds + Feedback",
//       description: "You'll do real mock interviews. We'll dissect your answers, body language, thought process – and help you fix the gaps before they become rejections."
//     }
//   ];
...
//               <span>Skill Preparation & Mentorship</span>
//             </div>
//           </Reveal>
...
//             >
//               Skill Preparation <br />
//               <span className="relative inline-block">
//                 <span className="italic" style={{ color: RED }}>And Personal Mentorship</span>
//                 <svg
...
//               Our Technical Guidance & Mentorship program is designed for serious tech candidates – 
//               developers, analysts, PMs, architects – who don't want to <span className="font-semibold text-black/80">"wing it"</span> anymore.
//             </p>
//           </Reveal>
...
//                     You get access to structured resources, real mock sessions, expert feedback, 
//                     and live mentorship. No more guessing what to study or how to prepare. 
//                     We give you a clear path to interview-ready confidence.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               >
//                 A Complete <br />
//                 <span className="italic" style={{ color: RED }}>Preparation Ecosystem</span>
//               </h2>
//             </Reveal>
//           </div>
...
//               style={{ fontFamily: "'Fraunces', serif" }}
//             >
//               “The mentorship program completely changed how I approach interviews. 
//               My mentor from Google helped me see the patterns behind the questions. 
//               I went from failing technical rounds to acing them.”
//             </motion.p>
//           </Reveal>
//           <Reveal custom={2}>
//             <div className="mt-8">
...
//                 ))}
//               </div>
//               <p className="mt-4 font-semibold text-black">— Alex Rivera</p>
//               <p className="text-sm text-black/40">Software Engineer at Meta</p>
//             </div>
//           </Reveal>
//         </div>
//       </section>
...
//               >
//                 Ready to Ace <br />Your Technical Interviews?
//               </h2>
//               <p className="mx-auto mt-4 max-w-xl text-sm text-white/70 sm:text-base">
//                 Stop guessing. Start preparing with expert mentorship, curated content, 
//                 and real mock interviews that build your confidence and skills.
//               </p>
...
// export default SkillPrepMentorshipPage;
...
export function SkillPrepMentorshipPage() {
  ...
  const mentorBenefits = [
    ...
    { icon: Users, label: "FAANG Mentors" },
    { icon: Zap, label: "Real Feedback" },
    { icon: Shield, label: "Confidence Build" },
  ];
  ...
  return (
    <main className="w-full overflow-x-hidden" style={{ background: BLACK }}>
        ...
        >
          ...
          <Reveal custom={2}>
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed md:text-lg" style={{ color: '#efefef' }}>
              Our Technical Guidance & Mentorship program is designed for serious tech candidates – 
              developers, analysts, PMs, architects – who don't want to <span className="font-semibold text-white">"wing it"</span> anymore.
            </p>
          </Reveal>
      ...
      <section className="py-10" style={{ background: DARK_SURFACE }}>
        <div className="mx-auto max-w-6xl px-6 md:px-10">
          ...
          <Reveal custom={1}>
            <h3
              style={{ fontFamily: "'Fraunces', serif" }}
              className="mt-4 text-center text-2xl font-medium text-white"
            >
              Learn From <span className="italic" style={{ color: RED }}>The Best</span>
            </h3>
          </Reveal>
        ...
        <div className="mx-auto max-w-4xl px-6 text-center md:px-10">
          ...
          <Reveal custom={2}>
            <div className="mt-8">
              ...
              <p className="mt-4 font-semibold text-white">— Alex Rivera</p>
              <p className="text-sm" style={{ color: '#efefef' }}>Software Engineer at Meta</p>
            </div>
          </Reveal>
        </div>
      </section>
      ...
      {/* -------- CTA -------- */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6" style={{ background: BLACK }}>
        <Reveal>
          <motion.div 
            whileHover={{ y: -4 }}
